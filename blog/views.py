...
def post_list(request):
    ...
    tone_analyzer = ToneAnalyzerV3(
        username='49380801-43c9-4981-922b-f083c79b809b',
        password='Nq2p1LrFfifj',
        version='2016-05-19 ')

    language_translator = LanguageTranslator(
        username='937e78b1-5e21-4cd2-aa95-273196375905',
        password='Mm4Q5FgmMrbt')
    ...
    for post in posts:
        ...
        post.translation = post.obj2['translations']
        post.spanish= post.translation[0]['translation']
        post.word_count = post.obj2['word_count']
        post.char=post.obj2['character_count']
